MediaPassport.Views.SearchResults = Backbone.CompositeView.extend({
  ...
  initialize: function (options) {
    ...
    this.listenToOnce(this._apiResults, "sync", this.appendNew);
    this.listenToOnce(this._localResults, "sync", this.renderItems);
  },
  ...
  //       var subView = new MediaPassport.Views.SearchResultShow({
  //         model: dbShow
  //       });
  //       this.addSubview('.results-list', subView)
  //     }.bind(this));
